namespace TRock.Music.Client
{
    ...
    public class UriQuery : IEnumerable<KeyValuePair<string, string>>
    {
        ...
        {
            this._entries.Add(new KeyValuePair<string, string>(key, value.ToString()));
            return this;
        }
        ...
        {
            this._entries.Add(new KeyValuePair<string, string>(key, value.ToString(CultureInfo.InvariantCulture)));
            return this;
        }
        ...
        {
            this._entries.Add(new KeyValuePair<string, string>(key, value.ToString().ToLower()));
            return this;
        }
        ...
        public override string ToString()
        {
            ...
            {
                queryBuilder.Append(this._baseUrl);
            }
